...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Seyfeddin Başsaraç/AnnounceKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Seyfeddin Başsaraç' => 'seyfeddin@wearethread.co' }
  s.source           = { :git => 'https://github.com/Seyfeddin Başsaraç/AnnounceKit.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'AnnounceKit/Classes/**/*'
